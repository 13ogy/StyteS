 ...
 *
 * <p>Optimisation : la version composite construisait un {@link
 * fr.sorbonne_u.cps.pubsub.messages.MessageFilter} with empty filter arrays. This class replaces
 * it: {@link #match(MessageI)} simply returns {@code true} without allocating or scanning any
 * property.
 *
 * <p>Use {@link fr.sorbonne_u.cps.pubsub.messages.MessageFilter#acceptAll()} to obtain the
 * canonical instance.
 *
