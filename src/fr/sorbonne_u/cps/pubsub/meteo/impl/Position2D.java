 ...
 *
 * <p>Pour respecter l'encapsulation OO, la logique de distance et d'inclusion involving 2D
 * positions are now methods of this class rather than callers pulling out raw {@code x}/{@code y}
 * coordinates. This restores the encapsulation of the position state.
 *
...
public class Position2D implements PositionI {
	 ...
	 *
	 * <p>Returns {@link Double#POSITIVE_INFINITY} for any incompatible {@link PositionI} subtype so
	 * callers remain comparison-safe.
	 *
	 * @param other another position.
	 * @return the Euclidean distance, or {@link Double#POSITIVE_INFINITY} if {@code other} is not a
	 *     {@link Position2D}.
	 */
