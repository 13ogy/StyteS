...
/**
 * Connecteur reliant le port outbound {@link ReceivingCI} du broker au port inbound {@link
 * ReceivingCI} d'un client (sens broker → client, inverse des trois autres connecteurs).
 *
 * <p><strong>Sens du raccordement</strong> : la référence {@link #offering} pointe vers le port
 * inbound du client qui offre {@link ReceivingCI}.
 *
