 ...
 *
 * <p>Each method handles a specific type of gossip message, allowing the broker to dispatch
 * processing without relying on instanceof checks. Implementations are responsible for updating the
 * broker's internal state accordingly.
 *
 * <p>This interface is intended to be used alongside {@link AbstractGossipMessage#accept}, which
 * performs the double-dispatch to the appropriate visit method.
 *
