...
public class BrokerGossipHandler implements GossipMessageVisitor {
    ...
    public void visit(RegisterGossipMessage regMsg) {
        System.out.print("received register gossip from "+ regMsg.getEmitterURI() +"\n");
    ...
    public void visit(PublishGossipMessage pubMsg) {
        System.out.print("received publish gossip from "+ pubMsg.getEmitterURI() +"\n");
    ...
    public void visit(CreateChannelGossipMessage ccMsg) {
        System.out.print("received channel creation gossip from "+ ccMsg.getEmitterURI() +"\n");
    ...
    public void visit(DestroyChannelGossipMessage dcMsg) {
        System.out.print("received destroy channel gossip from "+ dcMsg.getEmitterURI() +"\n");
    ...
    public void visit(ModifyServiceClassGossipMessage mscMsg) {
        System.out.print("received modify service class gossip from "+ mscMsg.getEmitterURI() +"\n");
    ...
    public void visit(ModifyAuthorisedUsersGossipMessage mauMsg) {
        System.out.print("received modify authorised users gossip from "+ mauMsg.getEmitterURI() +"\n");
    ...
    public void visit(UnregisterGossipMessage unregMsg) {
        System.out.print("received unregister gossip from "+ unregMsg.getEmitterURI() +"\n");
