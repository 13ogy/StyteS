...
/**
 * Composant utilitaire (démo) dont la seule responsabilité est d'exécuter un
 ...
 * ({@link ClocksServer#STANDARD_INBOUNDPORT_URI}) puis appelle
 * {@code executeTestScenario(...)}. Le scénario doit déjà avoir été construit
...
public class ScenarioRunner extends AbstractComponent
{
	...
	/**
	 * Initialise l'horloge accélérée puis exécute le scénario assigné, s'il
	 * existe. Appelé par le cycle de vie BCM après {@code start()}.
	 *
