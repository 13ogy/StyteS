...
/**
 * Message gossip propageant la <strong>modification de la liste des utilisateurs
 * autorisés</strong> sur un canal privilégié, à tous les courtiers voisins de la
 * fédération.
 *
 * <p><strong>Mutation broker répliquée (CDC §3.6)</strong></p>
 * <p>
 * Équivaut, côté broker récepteur, à un appel local
 * {@code modifyAuthorisedUsers(channel, authorisedUsers)} : chaque voisin
 * remplace la regex d'autorisation portée par sa réplique locale du canal.
 * </p>
 *
