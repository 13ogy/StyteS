...
/**
 * Message gossip propageant la <strong>destruction d'un canal privilégié</strong> à tous les
 * courtiers voisins de la fédération.
 *
 * <p><strong>Mutation broker répliquée (CDC §3.6)</strong>
 *
 * <p>Équivaut, côté broker récepteur, à un appel local {@code destroyChannel(channel,
 * ownerReceptionPortURI)} : chaque voisin supprime sa réplique locale du canal et libère le quota
 * associé au propriétaire (cf. {@code Broker#update(...)} sur ce type).
 *
