...
/**
 * Port entrant minimal {@link ReceivingCI} (TEST-ONLY) utilisé par {@link StubReceiverComponent}
 * dans les tests d'enregistrement du broker.
 *
 * <p>Le port ne fait rien sur {@code receive()} : il sert uniquement à fournir une URI publiée à
 * laquelle le broker peut se connecter via {@code doPortConnection()} sans avoir à fabriquer un
 * client réel.
 *
 ...
 */
public class StubReceivingInboundPort extends AbstractInboundPort implements ReceivingCI {
