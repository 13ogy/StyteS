...
/**
 * Fabrique construisant les messages d'alerte météo {@link MessageI} avec les propriétés attendues
 * par {@link MeteoFilters}.
 *
 * <p>Les noms de propriétés et le type de message sont centralisés ici afin de respecter le
 * principe DRY : aucun composant applicatif ne manipule de littéraux chaînes pour fabriquer un
 * message d'alerte. Un éventuel renommage de propriété s'effectue alors en un seul point.
 *
 * @author Bogdan Styn, Setbel Mélissa
 */
public final class MeteoAlertMessageFactory {
	private MeteoAlertMessageFactory() {
		/* factory only */
	}
	 ...
	 *
	 * <ul>
	 *   <li>{@link MeteoProperties#TYPE} = {@link MeteoProperties#TYPE_ALERT}
	 *   <li>{@link MeteoProperties#PAYLOAD} = the {@link MeteoAlertI} payload
	 *   <li>{@link MeteoProperties#OFFICE_ID} = {@code officeId}
	 *   <li>{@link MeteoProperties#LEVEL} = {@code alert.getLevel().toString()}
	 *   <li>{@link MeteoProperties#ALERT_TYPE} = {@code alert.getAlertType().toString()}
	 * </ul>
	 *
